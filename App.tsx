...
import GameEngine42 from './components/jp.n4.2/GameEngine';
...
const App = () => {
  ...
  if (activeModule === 'jp.n4.2') {
    return <GameEngine42 onExit={() => setActiveModule(null)} />;
  }
  ...
  if (activeModule === 'jp.n4.6') {
    return <GameEngine46 onExit={() => setActiveModule(null)} />;
  }
  if (activeModule === 'jp.n4.7') {
    return <GameEngine47 onExit={() => setActiveModule(null)} />;
  }
  ...
  return (
    <div className="min-h-screen bg-[#FDFCF5] text-slate-700 p-8 flex flex-col items-center font-['Nunito']">
      ...
      <main className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Card 02: Blue - Potential Form */}
        <div 
          onClick={() => setActiveModule('jp.n4.2')}
          className="group bg-white border-2 border-blue-100 hover:border-blue-400 rounded-2xl p-4 flex items-center gap-4 cursor-pointer transition-all hover:shadow-lg hover:-translate-y-0.5 relative overflow-hidden"
        >
          <div className="absolute right-0 top-0 bottom-0 w-1 bg-blue-400 scale-y-0 group-hover:scale-y-100 transition-transform origin-bottom" />
          
          <div className="w-12 h-12 shrink-0 bg-blue-50 group-hover:bg-blue-100 rounded-full flex items-center justify-center text-blue-500 group-hover:text-blue-600 transition-colors font-bold text-lg font-['Zen_Maru_Gothic']">
             02
          </div>
          <div className="flex-grow">
            <h3 className="font-bold text-slate-800 text-lg group-hover:text-blue-700 transition-colors">动词变形：可能态</h3>
            <p className="text-slate-400 text-sm group-hover:text-blue-500/80 transition-colors">Potential Form (～れる)</p>
          </div>
          <div className="text-blue-200 group-hover:text-blue-400 transition-colors transform group-hover:translate-x-1 duration-300">
             <Play size={24} fill="currentColor" />
          </div>
        </div>

        {/* Card 03: Indigo/Teal - Te Form */}
        <div 
        ...
        >
          <div className="absolute right-0 top-0 bottom-0 w-1 bg-indigo-400 scale-y-0 group-hover:scale-y-100 transition-transform origin-bottom" />
          
          <div className="w-12 h-12 shrink-0 bg-indigo-50 group-hover:bg-indigo-100 rounded-full flex items-center justify-center text-indigo-500 group-hover:text-indigo-600 transition-colors font-bold text-lg font-['Zen_Maru_Gothic']">
             03
          </div>
          <div className="flex-grow">
            <h3 className="font-bold text-slate-800 text-lg group-hover:text-indigo-700 transition-colors">动词变形：て形</h3>
            <p className="text-slate-400 text-sm group-hover:text-indigo-500/80 transition-colors">Te Form (～て)</p>
          </div>
        ...
        {/* Card 04: Rose - Nai Form */}
        <div 
          onClick={() => setActiveModule('jp.n4.4')}
          className="group bg-white border-2 border-rose-100 hover:border-rose-400 rounded-2xl p-4 flex items-center gap-4 cursor-pointer transition-all hover:shadow-lg hover:-translate-y-0.5 relative overflow-hidden"
        >
           <div className="absolute right-0 top-0 bottom-0 w-1 bg-rose-400 scale-y-0 group-hover:scale-y-100 transition-transform origin-bottom" />
           <div className="w-12 h-12 shrink-0 bg-rose-50 group-hover:bg-rose-100 rounded-full flex items-center justify-center text-rose-500 group-hover:text-rose-600 transition-colors font-bold text-lg font-['Zen_Maru_Gothic']">
            04
          </div>
          <div className="flex-grow">
            <h3 className="font-bold text-slate-800 text-lg group-hover:text-rose-700 transition-colors">动词变形：ない形</h3>
            <p className="text-slate-400 text-sm group-hover:text-rose-500/80 transition-colors">Nai Form (～ない)</p>
          </div>
        ...
        >
          ...
          <div className="w-12 h-12 shrink-0 bg-pink-50 group-hover:bg-pink-100 rounded-full flex items-center justify-center text-pink-500 group-hover:text-pink-600 font-bold text-lg font-['Zen_Maru_Gothic']">
             05
          </div>
          <div className="flex-grow">
        ...
        {/* Card 06: Violet - Causative Form */}
        <div 
          onClick={() => setActiveModule('jp.n4.6')}
        ...
        {/* Card 07: Orange - Causative Passive Form */}
        <div 
          onClick={() => setActiveModule('jp.n4.7')}
          className="group bg-white border-2 border-orange-100 hover:border-orange-400 rounded-2xl p-4 flex items-center gap-4 cursor-pointer transition-all hover:shadow-lg hover:-translate-y-0.5 relative overflow-hidden"
        >
          <div className="absolute right-0 top-0 bottom-0 w-1 bg-orange-400 scale-y-0 group-hover:scale-y-100 transition-transform origin-bottom" />
          <div className="w-12 h-12 shrink-0 bg-orange-50 group-hover:bg-orange-100 rounded-full flex items-center justify-center text-orange-500 group-hover:text-orange-600 font-bold text-lg font-['Zen_Maru_Gothic']">
             07
          </div>
          <div className="flex-grow">
            <h3 className="font-bold text-slate-800 text-lg group-hover:text-orange-700 transition-colors">动词变形：使役被动</h3>
            <p className="text-slate-400 text-sm group-hover:text-orange-500/80 transition-colors">Causative Passive (～させられる)</p>
          </div>
          <div className="text-orange-200 group-hover:text-orange-400 transition-colors transform group-hover:translate-x-1 duration-300">
             <Play size={24} fill="currentColor" />
          </div>
        </div>

        {/* Card 08: Cyan - Ta Form */}
        <div 
          onClick={() => setActiveModule('jp.n4.8')}
          className="group bg-white border-2 border-cyan-100 hover:border-cyan-400 rounded-2xl p-4 flex items-center gap-4 cursor-pointer transition-all hover:shadow-lg hover:-translate-y-0.5 relative overflow-hidden"
        >
          <div className="absolute right-0 top-0 bottom-0 w-1 bg-cyan-400 scale-y-0 group-hover:scale-y-100 transition-transform origin-bottom" />
          <div className="w-12 h-12 shrink-0 bg-cyan-50 group-hover:bg-cyan-100 rounded-full flex items-center justify-center text-cyan-500 group-hover:text-cyan-600 font-bold text-lg font-['Zen_Maru_Gothic']">
             08
          </div>
          <div className="flex-grow">
            <h3 className="font-bold text-slate-800 text-lg group-hover:text-cyan-700 transition-colors">动词变形：た形</h3>
